...
parser.add_argument('-key', '--key', default='ENTER_YOUR_FLICKR_API_KEY')
parser.add_argument('-ns', '--num-samples', type=int, default=10000)
parser.add_argument('-si', '--start-index', type=int, default=0)
parser.add_argument('--start-year', '-sy', default=2016, type=int)
...
# this shapefile is only for NYC, you need to look for new shapefiles if you want to dowload countries.
shapes = fiona.open("../utils/BoroughBoundaries/geo_export_c16f7a32-8d85-4e44-a14e-c4f6f350985d.shp")
polys = []
